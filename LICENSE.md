License: BSL1.1 with additional use grants

Licensor: Knowledge Integration Ltd

Licensed Work: web-toolkit - a utility library for building multitenant microservice components

Additional Use Grant:

The library may be freely distributed without restriction (including production environments) as a part of the following FOLIO modules
...
Change Date: 
- 2 years after the licensed work is published - where published means a specifically tagged release of the library rather than atomic commits to the repository 
- OR should Knowledge Integration Ltd cease trading without transfer to another party then the change will happen on the dissolution date indicated by companies house.

Change License: APL2.0
